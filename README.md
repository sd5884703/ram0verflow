...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1548"><img src="assets/ledger-light.svg?v=1548" width="100%" alt="ROFL ledger, height 1548"></picture>

| | |
|---|---|
| **height** | `1548` |
| **tip** | `ec84aac8dfce67a5bdfbf66382744240afdb4efeaa835ecc2b460ba6f243d3a9` |
| **difficulty** | `187.5`  (bits `0x1d15d860`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,421,127,956,566` expected hashes |
| **supply** | `20866.79687500 ROFL` in `1548` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `107` | `6.9%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2080.07812500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1548. Verify it yourself: <code>python3 verify.py</code></sub>
