...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1583"><img src="assets/ledger-light.svg?v=1583" width="100%" alt="ROFL ledger, height 1583"></picture>

| | |
|---|---|
| **height** | `1583` |
| **tip** | `fa7d49f8214fec53afbaf58db41966c89fdb2346dde4ccdc52a886cff314c0f8` |
| **difficulty** | `11.7`  (bits `0x1e015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,700,829,076` expected hashes |
| **supply** | `20880.46875000 ROFL` in `1583` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `142` | `9.0%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2093.75000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1583. Verify it yourself: <code>python3 verify.py</code></sub>
