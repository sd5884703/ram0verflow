...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1584"><img src="assets/ledger-light.svg?v=1584" width="100%" alt="ROFL ledger, height 1584"></picture>

| | |
|---|---|
| **height** | `1584` |
| **tip** | `8c5573a601571202985389e582bf79b65aeda5aecbcfb7d57ba4b7ea964c2570` |
| **difficulty** | `2.9`  (bits `0x1e057618`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,703,901,092` expected hashes |
| **supply** | `20880.85937500 ROFL` in `1584` unspent outputs |
...
| `1575` | `da74065b888bc04ebde6…` | [@ram0verflow](https://github.com/ram0verflow) | `gold tarnishes and must be secured` | `1` | `0.39062500` | 2026-09-21 18:51 UTC |
...
| [@ram0verflow](https://github.com/ram0verflow) | `143` | `9.0%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2094.14062500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1584. Verify it yourself: <code>python3 verify.py</code></sub>
