...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1568"><img src="assets/ledger-light.svg?v=1568" width="100%" alt="ROFL ledger, height 1568"></picture>

| | |
|---|---|
| **height** | `1568` |
| **tip** | `bf215473752fae1667d4243690cfe6262b38068414614172cc0b860bcb9c9f8f` |
| **difficulty** | `11.7`  (bits `0x1e015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,516,508,086` expected hashes |
| **supply** | `20874.60937500 ROFL` in `1568` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `127` | `8.1%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2087.89062500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1568. Verify it yourself: <code>python3 verify.py</code></sub>
