...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1565"><img src="assets/ledger-light.svg?v=1565" width="100%" alt="ROFL ledger, height 1565"></picture>

| | |
|---|---|
| **height** | `1565` |
| **tip** | `7a8c342d6d649b907c89647bcce996b0d7a6c34f3d88ad8aa44a74be651e0b8b` |
| **difficulty** | `46.9`  (bits `0x1d576180`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,405,915,488` expected hashes |
| **supply** | `20873.43750000 ROFL` in `1565` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `124` | `7.9%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2086.71875000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1565. Verify it yourself: <code>python3 verify.py</code></sub>
