...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1555"><img src="assets/ledger-light.svg?v=1555" width="100%" alt="ROFL ledger, height 1555"></picture>

| | |
|---|---|
| **height** | `1555` |
| **tip** | `fed0ba29cc332ed10f6f7aa3dcefe06e34905e4247d6a22dba12c5a69045506d` |
| **difficulty** | `46.9`  (bits `0x1d576180`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,421,914,392,828` expected hashes |
| **supply** | `20869.53125000 ROFL` in `1555` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `31.4%` |
...
| [@ram0verflow](https://github.com/ram0verflow) | `114` | `7.3%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2082.81250000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1555. Verify it yourself: <code>python3 verify.py</code></sub>
