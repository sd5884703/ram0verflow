...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1569"><img src="assets/ledger-light.svg?v=1569" width="100%" alt="ROFL ledger, height 1569"></picture>

| | |
|---|---|
| **height** | `1569` |
| **tip** | `3e07e2a6abb6f27689d7e782813d7bf530e341bd38f563e6316c7c803818a66e` |
| **difficulty** | `11.7`  (bits `0x1e015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,528,796,152` expected hashes |
| **supply** | `20875.00000000 ROFL` in `1569` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `128` | `8.2%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2088.28125000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1569. Verify it yourself: <code>python3 verify.py</code></sub>
