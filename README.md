...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1541"><img src="assets/ledger-light.svg?v=1541" width="100%" alt="ROFL ledger, height 1541"></picture>

| | |
|---|---|
| **height** | `1541` |
| **tip** | `cf784335398e028b451bc866d251c62e97c991dd8c01b87dc94b9a0dd575a4aa` |
| **difficulty** | `187.5`  (bits `0x1d15d860`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,419,751,693,104` expected hashes |
| **supply** | `20864.06250000 ROFL` in `1541` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1541` | `cf784335398e028b451b…` | [@ram0verflow](https://github.com/ram0verflow) | `transparent - everyone can verify their fair application` | `1` | `0.39062500` | 2026-09-16 18:46 UTC |
...
| [@ram0verflow](https://github.com/ram0verflow) | `100` | `6.5%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2077.34375000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1541. Verify it yourself: <code>python3 verify.py</code></sub>
