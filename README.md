...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1591"><img src="assets/ledger-light.svg?v=1591" width="100%" alt="ROFL ledger, height 1591"></picture>

| | |
|---|---|
| **height** | `1591` |
| **tip** | `51da562eccfda39edea8f1a946b93ea7ea8053b1f39f26c61fd8f26a8a652a3f` |
| **difficulty** | `2.9`  (bits `0x1e057618`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,725,405,204` expected hashes |
| **supply** | `20883.59375000 ROFL` in `1591` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `150` | `9.4%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2096.87500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1591. Verify it yourself: <code>python3 verify.py</code></sub>
