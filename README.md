...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1582"><img src="assets/ledger-light.svg?v=1582" width="100%" alt="ROFL ledger, height 1582"></picture>

| | |
|---|---|
| **height** | `1582` |
| **tip** | `38cb590d3d7d8f18d8120d040f7dc19ac3cc8d2735d6c8f6e9c1b8f1b6e62410` |
| **difficulty** | `11.7`  (bits `0x1e015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,422,688,541,010` expected hashes |
| **supply** | `20880.07812500 ROFL` in `1582` unspent outputs |
...
| `1574` | `2cfd63914f608b395382…` | [@ram0verflow](https://github.com/ram0verflow) | `attempts to change rules split the network` | `1` | `0.39062500` | 2026-09-21 13:22 UTC |
| `1573` | `5c1dcb4d804e897dbd4e…` | [@ram0verflow](https://github.com/ram0verflow) | `purpose exists because we cannot reach everything` | `1` | `0.39062500` | 2026-09-21 06:33 UTC |
...
| [@ram0verflow](https://github.com/ram0verflow) | `141` | `8.9%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2093.35937500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1582. Verify it yourself: <code>python3 verify.py</code></sub>
