...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1517"><img src="assets/ledger-light.svg?v=1517" width="100%" alt="ROFL ledger, height 1517"></picture>

| | |
|---|---|
| **height** | `1517` |
| **tip** | `25c84f089e644b1b21825455830fddecaf506139231290b64d0d34a969e6c699` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,399,697,568,344` expected hashes |
| **supply** | `20854.68750000 ROFL` in `1517` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `76` | `5.0%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2067.96875000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1517. Verify it yourself: <code>python3 verify.py</code></sub>
