...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1532"><img src="assets/ledger-light.svg?v=1532" width="100%" alt="ROFL ledger, height 1532"></picture>

| | |
|---|---|
| **height** | `1532` |
| **tip** | `05aa3891e72a8b9c0867f1ccf0ae47644cea27cb1ee0a16ab089fb2ce176a82d` |
| **difficulty** | `750.0`  (bits `0x1d057618`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,364,416,212,729,913` expected hashes |
| **supply** | `20860.54687500 ROFL` in `1532` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1532` | `05aa3891e72a8b9c0867…` | [@ram0verflow](https://github.com/ram0verflow) | `not just solving coincidence of time` | `1` | `0.39062500` | 2026-09-15 06:06 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `31.8%` |
| [@ywltby](https://github.com/ywltby) | `246` | `16.0%` |
...
| [@ram0verflow](https://github.com/ram0verflow) | `91` | `5.9%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2073.82812500 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1532. Verify it yourself: <code>python3 verify.py</code></sub>
